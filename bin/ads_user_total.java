...
//
// Debug information:
// Generated date: Fri Jun 25 19:02:28 CST 2021
...
public class ads_user_total extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.new_user_count = JdbcWritableBridge.readLong(2, __dbResults);
    this.new_order_user_count = JdbcWritableBridge.readLong(3, __dbResults);
    this.order_final_amount = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.order_user_count = JdbcWritableBridge.readLong(5, __dbResults);
    this.no_order_user_count = JdbcWritableBridge.readLong(6, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeLong(new_user_count, 2 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeLong(new_order_user_count, 3 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(order_final_amount, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeLong(order_user_count, 5 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeLong(no_order_user_count, 6 + __off, -5, __dbStmt);
    return 6;
  }
